...
export class TeamStack extends WorkshopStudioTeamStack {
  constructor(scope: Construct, id: string) {
    ...
    const commonRunner = new CodeBuildCustomResource(this, "EKSSECUCOMMON", {
      ...
      environmentVariables: {
        ...
        WORKSHOP_GIT_BRANCH: {
          value: process.env.WORKSHOP_GIT_BRANCH || "mainline",
        },
        ...
        mainSteps: [
          {
            ...
            inputs: {
              runCommand: [
                ...
                "MAX_ATTEMPTS=60",
                "WAIT_SECONDS=120",
                "DIRECTORY='/home/ec2-user/amazon-eks-security-immersion-day'",
                "",
