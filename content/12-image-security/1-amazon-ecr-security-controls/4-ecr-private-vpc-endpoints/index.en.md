...
![vpc endpoints](/static/images/image-security/ecr-security-controls/vpc-endpoints.png)

The VPC Endpoint policy document on the above 2 Interface type VPC endpoints looks like below in the AWS Console.
