...
You can see the readable (i.e. base64 format) version of the signature file.
...
Congratulations !!! You have successfully completed this section to create and verify digital signature using the openssl tool.
