...
Clicking on the `Signature` value in the **Artifact Type** column of the _untagged_ artifact indicates that its type is an `application/vnd.cncf.notary.signature`.

You can also see the corresponding Signing job in [AWS Signer Console](https://console.aws.amazon.com/signer/home?#/signing-jobs)
