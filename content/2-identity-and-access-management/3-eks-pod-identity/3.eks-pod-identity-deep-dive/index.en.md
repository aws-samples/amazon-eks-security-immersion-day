...
- apiVersion: apps/v1
  ...
  nodeSelectorTerms: - matchExpressions: - key: kubernetes.io/os
  operator: In
  values: - linux - key: kubernetes.io/arch
  operator: In
  values: - amd64 - arm64 - key: eks.amazonaws.com/compute-type
  operator: NotIn
  values: - fargate
  containers: - args: - --port - "80" - --cluster-name - eksworkshop-eksctl - --probe-port - "2703"
  ...
  name: proxy
  protocol: TCP - containerPort: 2703
  name: probes-port
  protocol: TCP
  readinessProbe:
  failureThreshold: 30
  ...
  hostNetwork: true
  initContainers: - command: - /go-runner - /eks-pod-identity-agent - initialize
  image: 602401143452.dkr.ecr.us-west-2.amazonaws.com/eks/eks-pod-identity-agent:0.0.25
  imagePullPolicy: Always
...
:::code{language=json showCopyAction=false showLineNumbers=true highlightLines='30,31,32'}
{
   ...
   "userIdentity":{
      ...
      "arn":"arn:aws:sts::012345678901:assumed-role/eks-security-workshop/i-07574d724fb843fda",
      ...
      "sessionContext":{
         "sessionIssuer":{
            ...
            "arn":"arn:aws:iam::012345678901:role/eks-security-workshop",
            "accountId":"012345678901",
...
:::code{language=json showCopyAction=false showLineNumbers=true highlightLines='11,14,17,23,27,53,71'}
{
   ...
   "requestParameters":{
      "roleArn":"arn:aws:iam::012345678901:role/eks-pod-s3-read-access-role",
      "roleSessionName":"eks-eksworksho-app1-498124c2-a555-40bf-9059-ca9a26821eb0",
      "durationSeconds":21600,
      "tags":[
         {
            "key":"eks-cluster-arn",
            "value":"arn:aws:eks:us-west-2:012345678901:cluster/eksworkshop-eksctl"
         },
         {
   ...
   "responseElements":{
      ...
      "assumedRoleUser":{
         ...
         "arn":"arn:aws:sts::012345678901:assumed-role/eks-pod-s3-read-access-role/eks-eksworksho-app1-498124c2-a555-40bf-9059-ca9a26821eb0"
      },
      "packedPolicySize":56
   },
   ...
   "resources":[
      {
         "accountId":"012345678901",
         "type":"AWS::IAM::Role",
         "ARN":"arn:aws:iam::012345678901:role/eks-pod-s3-read-access-role"
      }
   ],
   "eventType":"AwsApiCall",
   "managementEvent":true,
