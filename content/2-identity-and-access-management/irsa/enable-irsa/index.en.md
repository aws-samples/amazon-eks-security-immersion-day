...
In the above section, we saw that container is able to get access S# using fine grained IAM permissions. Now, let us inspect the additional token injected by the pod identity webhook.
