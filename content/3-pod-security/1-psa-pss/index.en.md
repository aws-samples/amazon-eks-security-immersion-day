...
A example Pod _Security Context_ can be seen below. The settings therein apply to every container within the pod, unless overridden by a container-level _Security Context_.
...
The following is a container-level _Security Context_ element. As you can see, it is more granular.
